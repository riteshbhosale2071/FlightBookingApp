...
import com.example.Project1.Adapter.SeatAdapter;
import com.example.Project1.Model.Flight;
import com.example.Project1.Model.Seat;
import com.example.Project1.databinding.ActivitySeatListBinding;
...
public class SeatListActivity extends BaseActivity {
    ...
    private void initSeatList() {
        ...
        SeatAdapter seatAdapter = new SeatAdapter(seatList, this, (selectedName, num) -> {
            ...
            this.num = num;
            binding.priceTxt.setText("Rs" + price);
        });
